...
datapath='D:\Conference and Journals\Revanth Conferences Completed\5th Paper\Dataset_A';
...
%     % Preprocessing Technique
    ...
    options = trainingOptions('adam',...
        'MaxEpochs',5,'MiniBatchSize',25,...
        'Shuffle','every-epoch', ...
        'InitialLearnRate',0.001, ...
        'Verbose',false, ...
        'Plots','training-progress');
%     options=trainingOptions('adam',...
%         'InitialLearnRate',0.001,'MaxEpochs',3,'MiniBatchSize',25,...
%         'Shuffle','every-epoch','validationFrequency',20,...
...
% Confusion Matrix
figure;
cm = confusionchart(actual_labels,predicted_labels','DiagonalColor',[0 0.4470 0.7410])
%plotconfusion(actual_labels,predicted_labels','blue')
title('Confusion Matrix for XceptionResNet50V2 - Fold 2');
